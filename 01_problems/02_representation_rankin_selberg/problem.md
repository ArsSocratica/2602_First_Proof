# Problem 2 — Representation Theory: Rankin–Selberg Integrals
...
$$\int_{N_n \backslash \mathrm{GL}_n(F)} W(\operatorname{diag}(g,1) u_Q) \, V(g) \, |\det g|^{s - \frac{1}{2}} \, dg$$
...
- Whittaker models and generic representations
- Local Rankin–Selberg integrals
- Conductor ideals
- GL(n) representation theory
