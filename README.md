...
All proofs and all Lean code were generated by AI: **Claude Opus 4.6** (Anthropic), **Gemini 3** (Google), **ChatGPT 5.2 Pro** (OpenAI), **Perplexity**, and **Grok** (xAI). The human operator directed strategy, reviewed axiom correctness, and prompted expansions. No mathematical content and no Lean code was written by the human operator. Full AI interaction transcripts are in `02_proofs/*/transcript.md`.
