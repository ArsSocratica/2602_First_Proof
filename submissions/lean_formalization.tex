...
numerical linear algebra.  The formalization comprises 1{,}926 lines of
...
\begin{enumerate}[nosep]
  \item A 1{,}926-line Lean~4 codebase with \textbf{9 of 10 main
...
\midrule
P01 & Stochastic PDE & 107 & 11 & 0 & Main thm \textbf{proved} from axioms \\
P02 & Representation theory & 207 & 16 & 0 & Universal test vector \textbf{proved} \\
P03 & Combinatorics & 185 & 12 & 0 & Markov chain existence \textbf{proved} \\
...
P07 & Lie groups & 160 & 12 & 0 & $\delta{=}0$ case \textbf{proved} \\
P08 & Symplectic geometry & 178 & 6 & 0 & Lagrangian smoothing \textbf{proved} \\
P09 & Multilinear algebra & 159 & 9 & 0 & Rank-1 characterization \textbf{proved} \\
P10 & Numerical linear algebra & 245 & 12 & 0 & Cost bound \textbf{proved} \\
\midrule
& \textbf{Total} & \textbf{1{,}926} & \textbf{118} & \textbf{1} & \\
\bottomrule
\end{tabular}
...
\begin{itemize}[nosep]
  \item \textbf{Total Lean lines}: 1{,}926 across 10 files
  ...
  \item \textbf{Smallest file}: P01 (107 lines)
...
% TODO: Add repository URL once pushed to GitHub
%\medskip\noindent\textbf{Repository:}
%\url{https://github.com/USERNAME/FirstProof}
...
\item Final state: 118 axioms, 1 \sorry{} (mathematically open), 1{,}926 lines.
\end{itemize}
