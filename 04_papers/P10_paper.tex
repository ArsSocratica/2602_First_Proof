...
This is the critical computation. The core idea---computing a subsampled Kronecker product matvec without forming the full product---is an instance of the generalized vec trick of Airola and Pahikkala~\cite{AP17}. We specialize their framework to our setting where only row selection (via~$S^T$) is needed, and break it into four steps.
...
\bibitem{AP17}
A.~Airola and T.~Pahikkala,
``Fast Kronecker product kernel methods via generalized vec trick,''
\textit{IEEE Trans.\ Neural Netw.\ Learn.\ Syst.}\ \textbf{29}(12) (2017), 5977--5988.
arXiv:1601.01507.
Theorem~1, Algorithm~1: Generalized vec trick for subsampled Kronecker product matvecs.
